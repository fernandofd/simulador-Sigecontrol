    ...
    if ([0, 1, 2, 5].includes(estado.funcao[indice])) {
        ...
        if (estado.funcao[indice] == 3) {
            if (indice % 2 == 0) {
                ...
                lampada.src = './motorBomba.png';
                lampadaMaior.src = './motorBomba.png';
...
function definirFuncao(indice, funcao) {
    if (estado.simuladorLigado) {
        ...
        if (funcao != 6) {
            ...
            // Desliga a lâmpada associada ao canal par quando 3 ou 7
            if (funcao == 3 || funcao == 7) {
            ...
            function atualiza(indice_par, valorfuncao) {
                estado.funcao[indice_par] = valorfuncao
                atualizarVisual(indice_par)
            }
        }
